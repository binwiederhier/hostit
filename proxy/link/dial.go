...
// the cluster CA.
func Role(authorize func(proxyID string) bool, sink api.ControlSink, register func(proxyID string, agent api.ProxyAgent), disconnect func(proxyID string, agent api.ProxyAgent)) *cluster.Role {
	return &cluster.Role{
...
func ServeAgent(conn net.Conn, proxyID string, agent api.ProxyAgent, onLink func(client *http.Client)) error {
