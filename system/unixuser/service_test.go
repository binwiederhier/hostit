...
func TestCreateUserArgsBringNoSkeleton(t *testing.T) {
	...
	args := createUserArgs("blog", "/var/lib/hostit/apps/blog", 1000000, "/usr/lib/hostit/bin/hostit-shell", "hostit-apps")
	...
	assert.Contains(t, joined, "--shell /usr/lib/hostit/bin/hostit-shell")
