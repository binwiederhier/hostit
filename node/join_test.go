...
func TestConnectHandlerRejectsHeaderIdentityOverTLS(t *testing.T) {
	...
	h := ConnectHandler(func(string) bool { return true }, nil, func(string, nodeapi.NodeAgent) {}, nil)
...
func TestConnectHandlerAuthorizesTheNode(t *testing.T) {
	...
	h := ConnectHandler(func(id string) bool { return id == "known" }, nil, func(string, nodeapi.NodeAgent) {}, nil)
	req := httptest.NewRequest("POST", connectPath, nil)
