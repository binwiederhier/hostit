...
const (
	...
	selectAppsByViewerQuery = `
		SELECT a.id, a.name, a.port, a.host, a.owner_id, a.disk_mb, a.created_at, a.image_tag, a.powered_off, a.uid, a.archived, a.private, a.memory_limit_mb, a.disk_limit_mb, a.cpu_milli, a.tabs, a.soft_deleted_at, a.listed
