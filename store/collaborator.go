...
const (
	...
	selectAppsByCollaboratorQuery = `
		SELECT a.id, a.name, a.port, a.host, a.owner_id, a.disk_mb, a.created_at, a.image_tag, a.powered_off, a.uid, a.archived, a.memory_limit_mb, a.disk_limit_mb, a.cpu_milli
